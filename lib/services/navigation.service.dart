...
import 'package:mahilasaarthi/views/pages/booking/booking.page.dart';
import 'package:mahilasaarthi/views/pages/commerce/commerce.page.dart';
import 'package:mahilasaarthi/views/pages/food/food.page.dart';
import 'package:mahilasaarthi/views/pages/grocery/grocery.page.dart';
import 'package:mahilasaarthi/views/pages/parcel/parcel.page.dart';
import 'package:mahilasaarthi/views/pages/pharmacy/pharmacy.page.dart';
...
import 'package:mahilasaarthi/views/pages/search/product_search.page.dart';
import 'package:mahilasaarthi/views/pages/search/search.page.dart';
import 'package:mahilasaarthi/views/pages/search/service_search.page.dart';
import 'package:mahilasaarthi/views/pages/service/service.page.dart';
import 'package:mahilasaarthi/views/pages/taxi/taxi.page.dart';
import 'package:mahilasaarthi/views/pages/vendor/vendor.page.dart';
